...
- Motion: a small disc flies from the previous lie (or tee) to a newly marked lie, and from the last lie into the basket when a hole score is recorded. Respect `prefers-reduced-motion`. Other motion is press feedback and the weather wind-arrow.
