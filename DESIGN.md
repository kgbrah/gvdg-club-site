...
- Variants: event card, casual round with share/add/manage tools, singles rows, doubles pair rows, matchplay status, dormie badge, hole map with a concrete tee pad aimed down the fairway and a chain-basket mark, waiting-on-you hint, tee-sign highlight, score conflicts, score-target warning, and current-hole states.
