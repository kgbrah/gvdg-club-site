/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 58bcf3975cf93a88cbd6ae9f87d2796c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_SEC" | "OPENROUTER_MODEL" | "ASSISTANT_MODEL" | "PAYPAL_ENV" | "RP_ID" | "RP_NAME" | "EXPECTED_ORIGIN" | "OPENROUTER_VISION_MODEL" | "VISION_MODEL" | "JWT_SECRET" | "OPENROUTER_API_KEY" | "PAYPAL_CLIENT_ID" | "PAYPAL_SECRET" | "VISION_DEV_STUB" | "ALLOWED_ORIGINS" | "PAYPAL_API_BASE">> {}
}
