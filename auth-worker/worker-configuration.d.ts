/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 3db4fa0de56de36e18249ede3008979c)
...
interface __BaseEnv_Env {
	...
	ORDER_NOTIFY_FROM?: string;
	REGISTER_NOTIFY_FROM?: string;
	...
	LIVE: DurableObjectNamespace<import("./src/index").LiveEventDO> | DurableObjectNamespace /* LiveEventDO from gvdg-member-auth-staging */;
	ASSISTANT_RL: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveEventDO";
	}
	interface StagingEnv {
		...
		ALLOWED_ORIGINS: string;
		PAYPAL_API_BASE: string;
		LIVE: DurableObjectNamespace<import("./src/index").LiveEventDO>;
		ASSISTANT_RL: RateLimit;
	}
	interface GvdgclubEnv {
		ROSTER: KVNamespace;
		RATELIMIT: KVNamespace;
		PHOTOS: R2Bucket;
		DB: D1Database;
		...
		ALLOWED_ORIGINS: string;
		PAYPAL_API_BASE: string;
		LIVE: DurableObjectNamespace /* LiveEventDO from gvdg-member-auth-staging */;
		ASSISTANT_RL: RateLimit;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_SEC" | "OPENROUTER_MODEL" | "OPENROUTER_FALLBACK_MODEL" | "ASSISTANT_MODEL" | "PAYPAL_ENV" | "ORDER_NOTIFY_EMAIL" | "ORDER_NOTIFY_FROM" | "REGISTER_NOTIFY_FROM" | "EMAIL_REPLY_TO" | "RP_ID" | "RP_NAME" | "EXPECTED_ORIGIN" | "GEMINI_VISION_MODEL" | "OPENROUTER_VISION_MODEL" | "VISION_MODEL" | "JWT_SECRET" | "GEMINI_API_KEY" | "OPENROUTER_API_KEY" | "PAYPAL_CLIENT_ID" | "PAYPAL_SECRET" | "VISION_DEV_STUB" | "ALLOWED_ORIGINS" | "PAYPAL_API_BASE">> {}
}
