...
test('member dashboard mounts a React-owned dashboard app without legacy fallbacks', () => {
  ...
  const seasonPage = readFileSync('src/members-app/season-page.js', 'utf8');
  const seasonModel = readFileSync('src/members-app/season-page-model.js', 'utf8');
  ...
  assert.match(html, /#membersReactSeasonPanel:not\(:empty\)/);
  assert.match(html, /#membersReactMorePanel:not\(:empty\)/);
  assert.match(html, /#membersReactPlayPanel:not\(:empty\)/);
  ...
  assert.match(dashboardApp, /MemberMorePage/);
  ...
  assert.match(dashboardApp, /id: "membersReactMorePanel"/);
  ...
  assert.match(pageChrome, /href: "score.html"/);
  assert.match(pageChrome, /Keep score/);
  ...
  assert.doesNotMatch(shell, /welcome-banner|id: "logoutBtn"/);
  ...
  assert.match(overview, /data-react-member-banner/);
  assert.doesNotMatch(overview, /MemberRegistrationPanel|data-react-dashboard-actions|data-react-account-tools/);
  assert.match(readFileSync('src/members-app/more-page.js', 'utf8'), /data-react-account-tools/);
  assert.match(readFileSync('src/members-app/more-page.js', 'utf8'), /data-react-passkey-action/);
  assert.match(readFileSync('src/members-app/more-page.js', 'utf8'), /data-react-passkey-status/);
  ...
  assert.match(readFileSync('src/members-app/more-page.js', 'utf8'), /tab: "play"/);
  assert.doesNotMatch(readFileSync('src/members-app/more-page.js', 'utf8'), /href: "score.html"/);
  ...
  assert.match(dashboardApp, /id: "playerPlay"/);
  assert.match(dashboardApp, /MemberPlayPage/);
  assert.match(readFileSync('src/members-app/overview-dashboard.js', 'utf8'), /HomeJobs/);
  const homeJobs = readFileSync('src/members-app/home-jobs.js', 'utf8');
  assert.match(homeJobs, /data-react-home-jobs/);
  assert.match(homeJobs, /data-react-home-pay/);
  ...
  assert.match(seasonPage, /fetchMergedRyderData/);
  assert.match(seasonPage, /applyOfficialRyderTally/);
  assert.match(seasonPage, /fallbackUnlessAborted/);
  assert.match(seasonPage, /AbortError/);
